      ...
      return (
        ...
        <Grid container item xs={12} >
            <Grid item xs={12} alignItems='center'>
                <Box display="flex"  className='principal2' justifyContent="center">
            ...
            <Grid item alignItems='center'>
                ...
                <Typography variant="h4" align="center" gutterBottom className='textos'>SOBRE O FRETE GRÁTIS</Typography>
                </Box>
            </Grid>
            <Grid item alignItems='center'>
                <Box  paddingTop={1} display='flex' justifyContent='center' alignItems='center'>
