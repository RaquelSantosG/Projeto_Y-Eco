        ...
        return (
                <Grid container >
                        ...
                        <Grid item xs={12} display='flex' justifyContent='center' alignItems="center" >
                                <Box paddingTop={1} display='flex' justifyContent='center' alignItems='center' className='title' marginBottom='10%'> <Typography variant="h4" align="center" gutterBottom className='textos' >Mais Vendidos</Typography>
                                </Box>
                        </Grid>
                        ...
                        <Grid item xs={12} display='flex' justifyContent='center' alignItems="center" >
                                <Box paddingTop={1} display='flex' justifyContent='center' alignItems='center' className='title' marginBottom='10%'> <Typography variant="h4" align="center" gutterBottom className='textos' >Destaques da Semana</Typography>
                                </Box>
                        </Grid>
                        <Grid item xs={6} display='flex' justifyContent="center" marginBottom='10%'>
                                <Card>
